...
TARGET_LIBINIT_DEFINES_FILE := $(LOCAL_PATH)/init/init_rio.c
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --dt device/huawei/rio/recovery/dt.img
TARGET_PREBUILT_KERNEL := device/huawei/rio/recovery/kernel
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 271228740864
